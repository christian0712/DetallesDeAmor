  ...
  return (
    <div className="min-h-screen bg-[#0b0512] text-white relative font-sans overflow-x-hidden selection:bg-rose-500 selection:text-white">
      ...
      <header className="fixed top-3 left-3 sm:top-4 sm:left-4 z-50">
        <Link
          href="/"
          className="px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-[#180a24]/90 hover:bg-[#28133b] text-rose-200 border border-rose-500/40 text-xs font-semibold backdrop-blur-md shadow-xl flex items-center gap-1.5 sm:gap-2 transition hover:scale-105"
        >
